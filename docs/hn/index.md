...
<a class="rw-card" href="2026-08-12/">
  <span class="rw-card__head"><span class="rw-card__source">📰 HackerNews</span><time class="rw-card__date">2026-08-12</time></span>
  <span class="rw-card__summary">Today’s tech landscape is dominated by an accelerating AI arms race, with debates over the timeline for runaway superintelligence, the rising costs of long agentic sessions, and ma…</span>
