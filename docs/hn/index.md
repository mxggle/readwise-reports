...
<a class="rw-card" href="2026-08-10/">
  <span class="rw-card__head"><span class="rw-card__source">📰 HackerNews</span><time class="rw-card__date">2026-08-10</time></span>
  <span class="rw-card__summary">Today’s tech discourse is split between the accelerating mainstreaming of AI—exemplified by Anthropic making auto mode the default in Claude Code—and a growing pushback against bot…</span>
